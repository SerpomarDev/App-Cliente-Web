...
import 'package:serpomar_client/src/pages/asignacion/address/create/asignacion_address_create_controller.dart';


class AsignacionAddressCreatePage extends StatelessWidget {

  AsignacionAddressCreateController con = Get.put(AsignacionAddressCreateController());
