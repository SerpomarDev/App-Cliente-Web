...
import 'package:serpomar_client/src/pages/asignacion/profile/info/asignacion_profile_info_controller.dart';
import 'package:sn_progress_dialog/progress_dialog.dart';
import 'package:serpomar_client/src/providers/users_provider.dart';

class AsignacionProfileUpdateController extends GetxController{
  ...
  AsignacionProfileInfoController asignacionProfileInfoController = Get.find();

  AsignacionProfileUpdateController(){
    ...
    if (isValidForm(name, lastname, phone)) {
      ...
      if (imageFile == null) {
        ...
        if (responseApi.success == true) {
          ...
          asignacionProfileInfoController.user.value = User.fromJson(GetStorage().read('user') ?? {});
        }
      }
      else {
