...
class RegisterController extends GetxController {
  ...
  void register(BuildContext context) async {
    ...
    if (isValidForm(email, name, lastname, phone, password, confirmPassword)) {
      ...
      try {
        dio.Response response = await usersProvider.createWithImage(user, imageFile!);
  ...
  void goToHomePage() {
    Get.offNamedUntil('/Asignacion/rutas/list', (route) => false);
  }
  ...
  bool isValidForm(
    ...
    if (lastname.isEmpty) {
      Get.snackbar('Formulario no valido', 'Debes ingresar un responsable');
      return false;
    }
    if (phone.isEmpty) {
