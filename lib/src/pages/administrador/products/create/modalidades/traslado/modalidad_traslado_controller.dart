...
class ModalidadTrasladoController extends GetxController {
  ...
  void getCategories() async {
    ...
    categories.clear();
    var importacionCategory = result.firstWhere((category) => category.id == '4', orElse: () => Category());
    if (importacionCategory != null && importacionCategory.id == '4') {
  ...
  bool isValidForm(String name, String description) {
    if (description.isEmpty) {
      Get.snackbar('Formulario no valido', 'Ingresa la descripcion de la RUTA');
      return false;
    }
    if (idCategory.value == '') {
  ...
  void clearForm() {
    ...
    remisionController.text = ''; // Limpia el campo "Remisión"
    observacionesController.text = ''; // Limpia el campo "Observaciones"
