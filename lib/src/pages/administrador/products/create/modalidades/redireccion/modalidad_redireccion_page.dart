...
import 'package:serpomar_client/src/pages/administrador/products/create/modalidades/redireccion/modalidad_redireccion_controller.dart';
...
class ModalidadRedireccionPage extends StatelessWidget {

  ModalidadRedireccionController con = Get.put(ModalidadRedireccionController());
        ...
        child: SafeArea(
          child: Column(
            children: <Widget>[
              ...
              ListTile(
                leading: Icon(Icons.list, color: Colors.indigoAccent),
                title: Text('Mis Solicitude'),
